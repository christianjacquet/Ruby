...
public class ConfigurationReader {
	...
	public ConfigurationReader(String fileName){
		...
		this.fXmlFile = new File("res/confw.xml");
	...
	public String getConfig(String tagName, String name, String propType, String propName){
		...
		for (int temp = 0; temp < nList.getLength(); temp++) {		 
			...
			if (eElement.getAttribute("name").equals(name)){
				NodeList prop = eElement.getElementsByTagName(propType);
				Node propnode = prop.item(0);
				Element propelement = (Element) propnode;
				return propelement.getAttribute(propName);
			}
		}
		return null;
	}
